    ...
    success:function(res){
      ...
      var html3=`
        ...
        <div class="carousel-item">
          ...
          <div class="carousel-caption d-flex justify-content-sm-end">
            <span  class='pfname  p-1 m-1'>${res[0].bg_pf2}</span> 
          </div> 
        </div>
        <div class="carousel-item">
        ...
        <div class="carousel-item">
          <img class="w-100" src="${res[0].bg_img4}"/>
          <div  class="carousel-caption d-flex justify-content-sm-end">
            <span  class='pfname  p-1 m-1'>${res[0].bg_pf4}  ${res[0].hname}</span> 
          </div> 
        </div>
        <div class="carousel-item">
          <img class="w-100" src="${res[0].bg_img5}"/>
          <div  class="carousel-caption d-flex justify-content-sm-end">
            <span  class='pfname  p-1 m-1'>${res[0].bg_pf5}  ${res[0].hname}</span> 
          </div> 
        </div>
      `;
